...
model = joblib.load('C:\\Users\\mamai\\OneDrive\\Desktop\\capstone\\model\\churn_model.pkl')
one_hot_columns = joblib.load('C:\\Users\\mamai\\OneDrive\\Desktop\\capstone\\encoder\\one_hot_columns.pkl')  # Columns from one-hot encoding
tenure_encoder = joblib.load('C:\\Users\\mamai\\OneDrive\\Desktop\\capstone\\encoder\\tenure_encoder.pkl')  # Encoder for scaling tenure
label_encoder = joblib.load('C:\\Users\\mamai\\OneDrive\\Desktop\\capstone\\encoder\\label_encoder.pkl')  # Label encoder for other categorical features
